...
We provide a [jupyter notebook](/museval18_analysis.ipynb) that includes all the results that were used to create the SiSEC evaluation. Also you can run the notebook on [google colab](https://drive.google.com/file/d/1DoGm0WizK_jmgdo1lSVAQRTMESNr6IyO/view?usp=sharing).
